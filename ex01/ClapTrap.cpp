...
ClapTrap::ClapTrap():
	_name(""), _hitPoints(10), _maxHitPoints(10), _energyPoints(10), 
	_maxEnergyPoints(10), _attackDamage(0)
{
...
ClapTrap::ClapTrap(std::string name):
	_name(name), _hitPoints(10), _maxHitPoints(10), _energyPoints(10), 
	_maxEnergyPoints(10), _attackDamage(0)
{
	std::cout << BLUE "ClapTrap first Param constructor called" RESET 
	<< std::endl;
}

ClapTrap::ClapTrap(std::string name, unsigned int hitPoints, 
	unsigned int energyPoints, unsigned int attackDamage) :
	_name(name), _hitPoints(hitPoints), _maxHitPoints(hitPoints), 
	_energyPoints(energyPoints), _maxEnergyPoints(energyPoints), 
	_attackDamage(attackDamage)
{
	std::cout << CYAN "ClapTrap Second Param constructor called" RESET 
	<< std::endl;
}
...
{
	std::cout << MAGENTA "ClapTrap Copy constructor called" RESET 
	<< std::endl;
	operator=(cl);
}
...
{
	std::cout << YELLOW "ClapTrap Operator = called" RESET
	<< std::endl;
	_name = cl._name;
...
{
	stream << BRIGHT_GREEN "ClapTrap " << _name << " has " << _hitPoints 
	<< " hit points, " << _energyPoints << " energy points and " 
	<< _attackDamage << " attack dammage.";
}
...
{
	std::cout << BRIGHT_GREEN "ClapTrap " << _name 
	<< " is repaired by " << amount << " points." RESET << std::endl;
